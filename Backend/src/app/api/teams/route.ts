/**
 * Route handler API per il recupero di tutti i team F1
...
export async function GET() {
  // Array per accumulare tutti i team fetched
  const allTeams: any[] = [];
  
  // Parametri paginazione
  const limit = 214; // Numero di elementi per richiesta
